...
const Menu = () => {
  return (
    <section className='w-full h-[100vh] flex items-center justify-center'>
      <article className='bg-white w-fit flex flex-col p-5 rounded-lg shadow-lg' id='Menu_Article__menuCard'>
        ...
        <p className='text-[.85rem]'>
          Precisa de Ajuda? Clique <a className='underline text-[.85rem] hover:cursor-pointer hover:text-blue-500' >aqui</a>.
        </p>
      </article>
    </section>
  )
